...
(function (TheDatepicker) {
    ...
    var Datepicker = (function () {
        ...
        Datepicker.prototype.getSelectedDateFormatted = function () {
            return this.dateConverter_.formatDate_(this.options.getInputFormat('YYYY-MM-DD'), this.viewModel_.selectedDate_);
        };
        ...
        Datepicker.prototype.parseRawInput = function () {
            return this.isInputTextBox_
                ? this.dateConverter_.parseDate_(this.options.getInputFormat('YYYY-MM-DD'), this.input.value)
                : null;
        };
        ...
        Datepicker.prototype.updateInput_ = function () {
            ...
            this.input.value = this.dateConverter_.formatDate_(this.options.getInputFormat('YYYY-MM-DD'), this.viewModel_.selectedDate_) || '';
            if (this.deselectElement_ !== null) {
    ...
    var Helper_ = (function () {
        ...
        Helper_.normalizeDate_ = function (parameterName, value, options) {
            ...
            if (typeof value === 'string') {
                ...
                var matches = value.match(/^\s*([+-]?)\s*([0-9]+)\s*(year|month|day)s?\s*$/i);
                if (matches !== null) {
