    ...
    <div id="container-register">
        ...
        <form action="Includes/signup.inc.php" method="post">
            ...
            <div class="input">
                ...
                <input id="vez_nev" placeholder="Vezetéknév" name="vez_nev" type="text" required class="validate">
                <input id="ker_nev" placeholder="Keresztnév" name="ker_nev" type="text" required class="validate">
                </div>
            </div>
