...
<form action="Includes/test.inc.php" method="post">
  ...
  <div class="rb-box">
    ...
    <!-- Radio Button Module -->
    <p class="p-text">Gyakran kételkedem a dolgokban</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Könnyen átélem mások érzéseit</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Kifolyik az idő a kezem közül</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Nehéz engem megismerni</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Nehezen értek meg absztrakt gondolatokat</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Ritkán vagyok ingerült</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Gyakran gondolom, hogy jobb vagyok másoknál</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Szeretem a rendet</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Erős személyiségem van</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Hiszek a művészet fontosságában</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <div class="button-box">
      <button class="button trigger" type="submit" name="submit2" disabled id="enable-on-two">Tovább</button>
    </div>
