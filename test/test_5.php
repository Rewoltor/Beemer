...
<form action="Includes/test.inc.php" method="post">
  ...
  <div class="rb-box">
    ...
    <!-- Radio Button Module -->
    <p class="p-text">Ritkán érzem magam depressziósnak</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Szimpatizálok mások érzéseivel</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Befejezem, amit elkezdek</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Könnyen megtalálom másokkal a közös hangot </p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Kerülöm a filozofikus kérdéseket</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Gyakran változik a hangulatom</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Nem szeretem a saját akaratomat érvényesíteni</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Nem zavarnak a rendetlen emberek</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Nem vagyok vezető típus</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <p class="p-text">Nem érdekel a költészet</p>      
    <div class="rb">
      <div class="rb-tab">
    ...
    <div class="button-box">
      <button class="button trigger" type="submit" name="submit5" disabled id="enable-on-two">Tovább</button>
    </div>
