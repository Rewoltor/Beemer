...
//THese are the input handlers, after submit the inputs are sorted here and than the correct function is called in functions.test.inc.php
//dbh.inc.php is called for the database
//q(x) is the name of the personality questionare
